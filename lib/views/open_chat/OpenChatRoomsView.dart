                                    ...
                                    child: Stack(
                                      children: [
                                        CircleAvatar(
                                          ...
                                          backgroundImage: room.iconUrl != null && room.iconUrl!.isNotEmpty
                                              ? ResizeImage(NetworkImage(room.iconUrl!), width: 138)
                                              : null,
                                          child: room.iconUrl == null || room.iconUrl!.isEmpty
                                              ? const Icon(
                                                  Icons.forum,
                                            ...
                                            children: tags.take(3).map((tag) {
                                              return InkWell(
                                                onTap: () {
                                                  ...
                                                  ref.read(openChatSearchQueryProvider.notifier).state = tag;
                                                },
